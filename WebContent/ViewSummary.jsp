...
<br/>
<h1 align="center" style="color: blue"> ONLINE CHAT SUMMERIZATION </h1>
<h3 align="center" style="color: blue"> Information Retrieval and Extraction, IIIT Hyderabad </h3>
 <h3 align="center" style="color: blue">INPUT FILE PATH:
 <input type="text" id="ipfile" style="width: 35%;height: 30px;margin-top: 3%;">
 </h3>
 <br/>
...
<h6 align="center"  style="color: blue ">By<br>Mridul Mundara - M.Tech <br>Snehal Shinde - M.Tech <br>Rishika Modi - M.Tech </h6>
</div>
<script>
page=0;
function submit(){
